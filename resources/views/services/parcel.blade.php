        ...
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
            <div class="max-w-3xl">
                ...
                <h1 class="mt-4 text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">
                    Bulk Parcel &amp; <span class="text-gold">Carton Delivery</span> in Jaipur
                </h1>
                <p class="mt-4 text-white/85 sm:text-lg max-w-xl">
                    Send multiple parcels, commercial boxes, or family gift cartons securely from Jaipur. Volume discounts, door pickup, and rapid transit via Air or Surface.
                </p>
                <div class="mt-7 flex flex-wrap gap-3">
                    <a href="https://wa.me/919000000000?text=Hi%20JM%20Courier%2C%20I%20want%20to%20send%20bulk%20parcels%20from%20Jaipur."
                ...
                <div class="mt-8 grid max-w-lg grid-cols-3 gap-4 text-center">
                    <div class="rounded-2xl bg-white/10 p-3 backdrop-blur border border-white/5 shadow-soft">
                        <div class="text-xl font-extrabold text-gold sm:text-2xl">Volume</div>
                        <div class="text-[10px] uppercase tracking-wider text-white/70">Discounts Active</div>
                    </div>
                    <div class="rounded-2xl bg-white/10 p-3 backdrop-blur border border-white/5 shadow-soft">
                        <div class="text-xl font-extrabold text-gold sm:text-2xl">Air &amp; Road</div>
                        <div class="text-[10px] uppercase tracking-wider text-white/70">Transport Modes</div>
                    </div>
                    <div class="rounded-2xl bg-white/10 p-3 backdrop-blur border border-white/5 shadow-soft">
                        <div class="text-xl font-extrabold text-gold sm:text-2xl">Secure</div>
                        <div class="text-[10px] uppercase tracking-wider text-white/70">Strapped Carton Packing</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid gap-12 lg:grid-cols-2 items-start">
            <div class="space-y-6">
                ...
                <div class="space-y-4 text-foreground/85 text-sm sm:text-base leading-relaxed">
                    <p>
                        Are you a textile manufacturer in Sanganer or Johri Bazar sending fabric rolls? A handicraft dealer dispatching wooden items? Or a family shipping heavy festival boxes to relatives? JM Courier is your primary solution for **bulk parcel delivery services in Jaipur**.
                    </p>
                    <p>
                        We specialize in handling bulk cartoon boxes, crates, and bundles, providing full weight verification, heavy strapping, and waterproof outer wrapping. 
                    </p>
                    <p>
                        Our logistics desk coordinates direct route optimization, allowing us to offer the lowest volumetric and weight-based rates for regular commercial dispatches from Jaipur.
                    </p>
                    <p>
                        We cater extensively to local traders, wholesalers, and e-commerce startups looking for reliable ground shipping to major e-commerce hubs and warehouses nationwide. Our collection executives pack, weigh, and seal your parcels directly on-site to ensure they are transit-ready.
                    </p>
                </div>
                <div class="flex flex-wrap gap-4 pt-4">
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-sm shadow-soft">
                        <x-icons.circle-check class="text-brand w-5 h-5 shrink-0" /> Bulk Weight Discount
                    </div>
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-sm shadow-soft">
                        <x-icons.circle-check class="text-brand w-5 h-5 shrink-0" /> Waterproof Wrapping
                    </div>
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-sm shadow-soft">
                        <x-icons.circle-check class="text-brand w-5 h-5 shrink-0" /> Sanganer Dispatch Hub
                    </div>
                </div>
            </div>
                    ...
                    <ul class="space-y-4">
                        <li class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Heavy cardboard boxes filled with clothes, household goods, utensils, and corporate merchandise.</p>
                            </div>
                        </li>
                        <li class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Apparel bundles and rolls packed in secure sacks, ready for dispatch to major retail hubs.</p>
                            </div>
                        </li>
                        <li class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Jaipur marble articles, wooden artifacts, and blue pottery items packed using double bubble-wrap layers.</p>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="mx-auto w-full max-w-7xl px-4 sm:px-6">
            ...
            <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-6">
                ...
                <div class="relative rounded-2xl bg-white/5 p-6 ring-1 ring-white/10 backdrop-blur">
                    ...
                    <p class="mt-1 text-xs text-white/75">Delivered and signed off by the receiving warehouse or retail shop.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div class="grid gap-12 lg:grid-cols-2">
            <div>
                ...
                <p class="mt-2 text-muted-foreground text-sm">Typical weight tier rates from Jaipur to major state capitals.</p>
            ...
            <div>
                ...
                <p class="mt-2 text-muted-foreground text-sm">Simple packaging guidelines to assure safety of cardboard parcels.</p>
                ...
                <div class="mt-6 space-y-4">
                    <div class="rounded-2xl border border-border bg-card p-5 hover:border-brand/40 transition">
                        ...
                        <p class="text-xs text-muted-foreground mt-1">Single-walled thin cardboard boxes break under pressure. Always pack heavy volumes in multi-layered heavy-duty cartons (5-ply or 7-ply) to bear transport stack loads.</p>
                    </div>
                    ...
                    <div class="rounded-2xl border border-border bg-card p-5 hover:border-brand/40 transition">
                        ...
                        <p class="text-xs text-muted-foreground mt-1">Fill empty box corners with crumpled paper, bubble wrap, or styrofoam peanuts. Empty space inside a parcel leads to structural collapse when stacked.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="faq-item rounded-2xl border border-border bg-card group">
                ...
                <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        Yes. We can supply durable multi-layered cardboard boxes, bubble wrap, packing tapes, and heavy-duty box strapping services on request. Tell us your dimensions beforehand so our team can bring them.
                    </p>
                </div>
            </div>
            <div class="faq-item rounded-2xl border border-border bg-card group">
                ...
                <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        Our special discounted commercial and bulk parcel rates apply starting from 50kg or above. For smaller packages, we offer highly competitive standard domestic courier tariffs.
                    </p>
                </div>
            </div>
            <div class="faq-item rounded-2xl border border-border bg-card group">
                ...
                <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        Absolutely. We regularly pick up bulk shipments from Sanganer, Sitapura Industrial Area, Mansarovar, Johri Bazar, Malviya Nagar, and all commercial pockets of Jaipur.
                    </p>
                </div>
            </div>
        </div>
