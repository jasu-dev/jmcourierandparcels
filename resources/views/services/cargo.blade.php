...
@section('content')
        ...
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
            <div class="max-w-3xl">
                ...
                <p class="mt-4 text-white/85 sm:text-lg max-w-xl">
                    Reliable LTL &amp; FTL transport options from Jaipur for heavy machinery, raw materials, commercial inventory, and bulk personal shipments. Managed by professionals.
                </p>
                ...
                <div class="mt-8 grid max-w-lg grid-cols-3 gap-4 text-center">
                    <div class="rounded-2xl bg-white/10 p-3 backdrop-blur border border-white/5 shadow-soft">
                        <div class="text-xl font-extrabold text-gold sm:text-2xl">LTL &amp; FTL</div>
                        <div class="text-[10px] uppercase tracking-wider text-white/70">Flexible Loads</div>
                    </div>
                    <div class="rounded-2xl bg-white/10 p-3 backdrop-blur border border-white/5 shadow-soft">
                        <div class="text-xl font-extrabold text-gold sm:text-2xl">Heavy Cargo</div>
                        <div class="text-[10px] uppercase tracking-wider text-white/70">Loading Team</div>
                    </div>
                    <div class="rounded-2xl bg-white/10 p-3 backdrop-blur border border-white/5 shadow-soft">
                        <div class="text-xl font-extrabold text-gold sm:text-2xl">GPS Tracked</div>
                        <div class="text-[10px] uppercase tracking-wider text-white/70">Fleet Updates</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid gap-12 lg:grid-cols-2 items-start">
            <div class="space-y-6">
                ...
                <div class="space-y-4 text-foreground/85 text-sm sm:text-base leading-relaxed">
                    <p>
                        Are you managing a manufacturing unit or wholesaling enterprise in Sanganer, Sitapura, or VKI? As a premier choice for **commercial cargo services in Jaipur**, JM Courier offers specialized transport networks to transport raw materials, factory machines, and bulk inventory.
                    </p>
                    <p>
                        We offer both Less-than-Truckload (LTL) booking—letting you pay only for the weight and volume your cargo occupies—and Full Truckload (FTL) services for absolute container exclusivity. Our logistics experts oversee route clearance, toll manifesting, and e-way bill compliance, reducing loading delays.
                    </p>
                    <p>
                        Our handling staff is fully trained to manage heavy lifts. On-site wooden crating, metal strapping, and heavy bubble wrapping are available for high-value machinery, fragile industrial moulds, and decorative marble artifacts to keep them safe from vibrations.
                    </p>
                    <p>
                        With real-time GPS tracking enabled across our closed-body container fleet, you will receive up-to-date statuses from Jaipur dispatch all the way to final commercial delivery across India.
                    </p>
                </div>
                
                <!-- Active Industrial Hubs in Jaipur -->
                <div class="pt-4">
                    <h4 class="font-bold text-navy text-sm uppercase tracking-wide mb-3">Key Jaipur Industrial Collection Areas:</h4>
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
                        <div class="flex items-center gap-1.5 text-xs text-muted-foreground"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>Sitapura Industrial Area</div>
                        <div class="flex items-center gap-1.5 text-xs text-muted-foreground"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>Sanganer Industrial Hub</div>
                        <div class="flex items-center gap-1.5 text-xs text-muted-foreground"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>VKI Industrial Area</div>
                        <div class="flex items-center gap-1.5 text-xs text-muted-foreground"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>Mansarovar Industrial Zone</div>
                        <div class="flex items-center gap-1.5 text-xs text-muted-foreground"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>Jhotwara &amp; Kanakpura</div>
                        <div class="flex items-center gap-1.5 text-xs text-muted-foreground"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>Sudershanpura &amp; Malviya</div>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap gap-4 pt-4">
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-sm shadow-soft">
                        <x-icons.circle-check class="text-brand w-5 h-5 shrink-0" /> Custom Crate Packaging
                    </div>
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-sm shadow-soft">
                        <x-icons.circle-check class="text-brand w-5 h-5 shrink-0" /> Loading &amp; Forklift Team
                    </div>
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-sm shadow-soft">
                        <x-icons.circle-check class="text-brand w-5 h-5 shrink-0" /> GST Invoicing &amp; E-Way Bills
                    </div>
                </div>
            </div>
                    ...
                    <ul class="space-y-4">
                        <li class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Heavy industrial tooling, machinery frames, control panels, and auto parts packed in heavy wooden cases.</p>
                            </div>
                        </li>
                        <li class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Apparel bundles, wholesale cotton fabric rolls, and home furnishings wrapped in protective canvas stacks.</p>
                            </div>
                        </li>
                        <li class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Highly fragile marble idols, craft pillars, and stone articles strapped on custom wood pallets.</p>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="mx-auto w-full max-w-7xl px-4 sm:px-6">
            ...
            <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-6">
                ...
                <div class="relative rounded-2xl bg-white/5 p-6 ring-1 ring-white/10 backdrop-blur">
                    ...
                    <p class="mt-1 text-xs text-white/75">Verification of GST documents and road bills done prior to loading.</p>
                </div>
                <div class="relative rounded-2xl bg-white/5 p-6 ring-1 ring-white/10 backdrop-blur">
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div class="grid gap-12 lg:grid-cols-2">
            <div>
                ...
                <p class="mt-2 text-muted-foreground text-sm">We operate structured vehicle sizes out of Jaipur for diverse load volumes.</p>
            ...
            <div>
                ...
                <p class="mt-2 text-muted-foreground text-sm">Our core operations feature specialized cargo safety standards.</p>
                ...
                <div class="mt-6 space-y-4">
                    <div class="rounded-2xl border border-border bg-card p-5 hover:border-brand/40 transition">
                        ...
                        <p class="text-xs text-muted-foreground mt-1">Consolidate your heavy boxes, marble blocks, or textile bales with other commercial shipments at optimized rates.</p>
                        <ul class="mt-3 grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                            <li class="flex items-center gap-1.5"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>Pay only by occupied volume</li>
                            <li class="flex items-center gap-1.5"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>Daily Sanganer pickups</li>
                            <li class="flex items-center gap-1.5"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>Regular metro hub drops</li>
                            <li class="flex items-center gap-1.5"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>Standard transit timelines</li>
                        </ul>
                    </div>
                    ...
                    <div class="rounded-2xl border border-border bg-card p-5 hover:border-brand/40 transition">
                        ...
                        <p class="text-xs text-muted-foreground mt-1">Book an exclusive vehicle for sensitive machinery, high-volume textile rolls, or complex factory inputs.</p>
                        <ul class="mt-3 grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                            <li class="flex items-center gap-1.5"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>Exclusive container</li>
                            <li class="flex items-center gap-1.5"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>Zero intermediate sorting</li>
                            <li class="flex items-center gap-1.5"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>Point-to-point speed</li>
                            <li class="flex items-center gap-1.5"><span class="w-1.5 h-1.5 bg-brand rounded-full"></span>GPS geo-fence alerts</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 border-t border-border/50">
        <div class="max-w-2xl">
            ...
            <p class="mt-2 text-muted-foreground text-sm">Need smaller, express, or student-specific shipping from Jaipur?</p>
        </div>
            ...
            <div class="faq-item rounded-2xl border border-border bg-card group">
                ...
                <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        LTL (Less-than-Truckload) means your cargo shares container space with other shipments, letting you pay only for the weight/volume you occupy. FTL (Full Truckload) books the entire container specifically for your shipment, offering faster direct transit without intermediate stops.
                    </p>
                </div>
            </div>
            <div class="faq-item rounded-2xl border border-border bg-card group">
                ...
                <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        Yes, we offer complete customized on-site wooden box, crate, and pallet packaging solutions in Jaipur for fragile items, industrial machinery, marble sculpture blocks, and automotive parts.
                    </p>
                </div>
            </div>
            <div class="faq-item rounded-2xl border border-border bg-card group">
                ...
                <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        Cargo rates are calculated based on weight, dimensions (chargeable volumetric weight), type of loading material, pickup address in Jaipur, and destination city distance. WhatsApp our desk for an instant customized estimate.
                    </p>
                </div>
            </div>
        </div>
