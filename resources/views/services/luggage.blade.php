...
@push('meta')
    <title>Student & Household Luggage Transport Services in Jaipur</title>
    <meta name="description" content="Move your luggage, excess baggage, books, and household items from Jaipur. Safe, reliable, and cheap luggage transport service for students and families.">
    <meta name="keywords" content="luggage transport jaipur, student luggage shifting, excess baggage delivery jaipur, house shifting jaipur, luggage parcel service">
    <meta property="og:title" content="Student & Household Luggage Transport Services in Jaipur">
    <meta property="og:description" content="Move your luggage, excess baggage, books, and household items from Jaipur. Safe, reliable, and cheap luggage transport service for students and families.">
    <meta name="twitter:title" content="Student & Household Luggage Transport Services in Jaipur">
    <meta name="twitter:description" content="Move your luggage, excess baggage, books, and household items from Jaipur. Safe, reliable, and cheap luggage transport service for students and families.">
@endpush
...
@section('content')
    ...
    <section class="relative overflow-hidden bg-hero-gradient text-white">
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
            ...
            <h1 class="mt-4 text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">
                Luggage Transport Services in Jaipur
            </h1>
            <p class="mt-4 text-white/85 sm:text-lg">
                Send suitcases, bags, trunks, and household luggage safely from Jaipur to hostels, universities, or homes
                across India. Low rates, careful handling, and doorstep pickup.
            </p>
            <div class="mt-7 flex flex-wrap gap-3">
                <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20am%20a%20student%2Fcustomer%20and%20want%20to%20send%20my%20luggage%20from%20Jaipur."
        ...
        <div class="grid gap-12 lg:grid-cols-2 items-start">
            <div class="space-y-6">
                ...
                <div class="space-y-4 text-foreground/85 text-sm sm:text-base leading-relaxed">
                    <p>
                        Are you a student preparing to join a university in Delhi, Pune, Mumbai, Bangalore, or Chennai? Or a
                        corporate professional transitioning for a new role? Carrying heavy suitcases, trunks, and carton
                        boxes on trains and flights is exhausting, expensive, and stressful.
                    </p>
                    <p>
                        JM Courier provides highly rated, specialized **luggage transport services in Jaipur** designed to
                        safely ship your suitcases, study materials, storage containers, bedding, and sports kits. Our local
                        team visits your residential colony, PG, hostel, or rental flat to take care of the heavy lifting.
                    </p>
                    <p>
                        We know that personal belongings hold sentimental value. That is why we offer bubble-wrapping,
                        heavy-duty carton boxes, and an outer layer of thick stretch wrap to defend your baggage from
                        moisture, friction scratches, and dust during road transit.
                    </p>
                    <p>
                        Simply share your baggage details on WhatsApp, secure a flat weight-based estimate, and schedule a
                        convenient doorstep collection time. We handle the rest, delivering your bags directly to your
                        hostel room, flat door, or home gate.
                    </p>
                </div>
                <div class="flex flex-wrap gap-4 pt-4">
                    <div
                        class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-xs">
                        <x-icons.circle-check class="text-brand w-4 h-4 shrink-0" /> Hostels & PG Pickups
                    </div>
                    <div
                        class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-xs">
                        <x-icons.circle-check class="text-brand w-4 h-4 shrink-0" /> Shrink Wrap Protection
                    </div>
                    <div
                        class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-xs">
                        <x-icons.circle-check class="text-brand w-4 h-4 shrink-0" /> Flat Weight Pricing
                    </div>
                </div>
            </div>
                    ...
                    <ul class="space-y-4">
                        <li class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Heavy suitcases, rolling trolley
                                    bags, duffels, and backpacks securely sealed and wrapped.</p>
                            </div>
                        </li>
                        <li class="flex gap-3">
                            <div
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Durable tin storage boxes and
                                    trunks commonly shipped by hostel students and military personnel.</p>
                            </div>
                        </li>
                        <li class="flex gap-3">
                            <div
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Separate cartons packed with
                                    textbooks, mattresses, blankets, pillows, and folding tables.</p>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div class="grid gap-12 lg:grid-cols-2">
            <div>
                ...
                <p class="mt-2 text-muted-foreground text-sm">We provide routine student relocations from Jaipur to top
                    academic cities.</p>
            ...
            <div>
                ...
                <p class="mt-2 text-muted-foreground text-sm">Follow these packing recommendations to keep your luggage
                    intact.</p>
                ...
                <div class="mt-6 space-y-4">
                    <div class="rounded-2xl border border-border bg-card p-5 hover:border-brand/40 transition">
                        ...
                        <p class="text-xs text-muted-foreground mt-1">Textbooks, notes, and files are dense and heavy.
                            Place them in double-walled corrugated cardboard boxes to prevent the carton from bursting open.
                        </p>
                    </div>
                    ...
                    <div class="rounded-2xl border border-border bg-card p-5 hover:border-brand/40 transition">
                        ...
                        <p class="text-xs text-muted-foreground mt-1">Ensure all zippers are locked securely or zipped
                            completely. Tape loose tags and keep documents or keys separate in your hand baggage.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 border-t border-border/50">
        <div class="max-w-2xl">
            ...
            <p class="mt-2 text-muted-foreground text-sm">Need to ship express documents or heavy business cargo from
                Jaipur?</p>
        </div>
            ...
            <div class="faq-item rounded-2xl border border-border bg-card group">
                ...
                <div
                    ...
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        We recommend locking all bags and suitcases, removing external luggage tags, and packing heavy books
                        or footwear at the bottom. Our Jaipur pickup team can apply professional stretch-wrap to protect the
                        outer bag material from moisture and dust.
                    </p>
                </div>
            </div>
            <div class="faq-item rounded-2xl border border-border bg-card group">
                ...
                <div
                    class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        Yes, we offer seasonal student discounts for shipping personal luggage, study materials, and PG
                        items from Jaipur to colleges in Delhi, Chennai, Bangalore, Pune, and elsewhere. Just show your
                        student ID card during booking!
                    </p>
                </div>
            </div>
            <div class="faq-item rounded-2xl border border-border bg-card group">
                ...
                <div
                    class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        There is no maximum limit, but we recommend dividing luggage into bags of 20-30kg each so they can
                        be handled safely without risk of damage to the handles or zippers during manual loading.
                    </p>
                </div>
            </div>
        </div>
