...
@push('meta')
    <title>Best Domestic Courier Services in Jaipur | JM Courier</title>
    <meta name="description" content="Fast and reliable document and parcel courier services in Jaipur. Affordable rates, door-to-door pickup, and secure delivery to all cities across India.">
    <meta name="keywords" content="domestic courier jaipur, document courier service jaipur, fast courier jaipur, door to door courier jaipur, cheap courier jaipur">
    <meta property="og:title" content="Best Domestic Courier Services in Jaipur | JM Courier">
    <meta property="og:description" content="Fast and reliable document and parcel courier services in Jaipur. Affordable rates, door-to-door pickup, and secure delivery to all cities across India.">
    <meta name="twitter:title" content="Best Domestic Courier Services in Jaipur | JM Courier">
    <meta name="twitter:description" content="Fast and reliable document and parcel courier services in Jaipur. Affordable rates, door-to-door pickup, and secure delivery to all cities across India.">
@endpush
    ...
    <section class="relative overflow-hidden bg-hero-gradient text-white">
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
            ...
            <p class="mt-4 text-white/85 sm:text-lg">
                Get fast, secure, and affordable door-to-door courier delivery from Jaipur to all major cities across India.
                Perfect for urgent documents, corporate samples, and small packages.
            </p>
            <div class="mt-7 flex flex-wrap gap-3">
                <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20book%20a%20courier%20pickup%20from%20Jaipur."
        ...
        <div class="grid gap-12 lg:grid-cols-2 items-start">
            <div class="space-y-6">
                ...
                <div class="space-y-4 text-foreground/85 text-sm sm:text-base leading-relaxed">
                    <p>
                        Are you looking for the <b>best courier services in Jaipur</b> to send a critical document or a retail
                        parcel? At JM Courier, we provide tailored, secure, and fast domestic logistics from Jaipur to all
                        major Indian cities. We serve individuals, small business owners, corporate houses, and institutions
                        daily.
                    </p>
                    <p>
                        Our specialized domestic network guarantees quick collection directly from Sanganer, Mansarovar,
                        C-Scheme, Vaishali Nagar, Malviya Nagar, Raja Park, and other parts of Jaipur. If you book before
                        5:00 PM, our field executive will collect your shipment from your home or office on the very same
                        day.
                    </p>
                    <p>
                        We use high-grade security bags, bubble wrap, and corrugated envelopes to shield time-sensitive
                        documents, bank draft envelopes, medical records, legal contracts, and electronic gadgets from
                        weather damage and rough handling.
                    </p>
                    <p>
                        With priority sorting at our Jaipur hub and express channels, we drastically cut transit times to
                        central business districts across India. You get instant updates from dispatch to final delivery,
                        ensuring peace of mind throughout the transit cycle.
                    </p>
                </div>
                <div class="flex flex-wrap gap-4 pt-4">
                    ...
                    <div
                        class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-xs">
                        <x-icons.circle-check class="text-brand w-4 h-4 shrink-0" /> Real-time SMS Updates
                    </div>
                    <div
                        class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-xs">
                        <x-icons.circle-check class="text-brand w-4 h-4 shrink-0" /> Corporate Billing Options
                    </div>
                </div>
            </div>
                    ...
                    <ul class="space-y-4">
                        <li class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Tenders, legal deeds, contracts,
                                    and transcripts sealed in security envelopes.</p>
                            </div>
                        </li>
                        <li class="flex gap-3">
                            <div
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Product prototypes, apparel
                                    samples from Jaipur weavers, and festival gift packs.</p>
                            </div>
                        </li>
                        <li class="flex gap-3">
                            <div
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Urgent pharmacy orders,
                                    cold-chain diagnostic kits, and health documents.</p>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div class="grid gap-12 lg:grid-cols-2">
            <div>
                ...
                <p class="mt-2 text-muted-foreground text-sm">Regular express shipments depart daily from Jaipur to major
                    corridors.</p>
            ...
            <div>
                ...
                <p class="mt-2 text-muted-foreground text-sm">Choose the courier speed and features that match your
                    timeline.</p>
                ...
                <div class="mt-6 space-y-4">
                    <div class="rounded-2xl border border-border bg-card p-5 hover:border-brand/40 transition">
                        ...
                        <p class="text-xs text-muted-foreground mt-1">Dedicated priority air cargo slots for documents,
                            files, and high-value prototypes.</p>
                        <ul class="mt-3 grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                            <li class="flex items-center gap-1.5"><span
                                    class="w-1.5 h-1.5 bg-brand rounded-full"></span>Next-day delivery option</li>
                            <li class="flex items-center gap-1.5"><span
                                    class="w-1.5 h-1.5 bg-brand rounded-full"></span>Dedicated sorting queue</li>
                            <li class="flex items-center gap-1.5"><span
                                    class="w-1.5 h-1.5 bg-brand rounded-full"></span>WhatsApp tracking support</li>
                            <li class="flex items-center gap-1.5"><span
                                    class="w-1.5 h-1.5 bg-brand rounded-full"></span>Highest security handling</li>
                        </ul>
                    </div>
                    ...
                    <div class="rounded-2xl border border-border bg-card p-5 hover:border-brand/40 transition">
                        ...
                        <p class="text-xs text-muted-foreground mt-1">Cost-efficient overland transport for larger folders,
                            heavy books, and non-urgent files.</p>
                        <ul class="mt-3 grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                            <li class="flex items-center gap-1.5"><span
                                    class="w-1.5 h-1.5 bg-brand rounded-full"></span>Lowest price point</li>
                            <li class="flex items-center gap-1.5"><span
                                    class="w-1.5 h-1.5 bg-brand rounded-full"></span>Reliable surface transit</li>
                            <li class="flex items-center gap-1.5"><span
                                    class="w-1.5 h-1.5 bg-brand rounded-full"></span>Full online tracking</li>
                            <li class="flex items-center gap-1.5"><span
                                    class="w-1.5 h-1.5 bg-brand rounded-full"></span>Doorstep collection</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="mx-auto mt-8 max-w-3xl space-y-2 overflow-hidden px-4">
            <div class="faq-item rounded-2xl border border-border bg-card group">
                ...
                <div
                    ...
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        You can easily book a courier pickup by clicking our "Book Express Pickup" button to launch
                        WhatsApp, or by calling our customer care number. Our Jaipur pickup team will arrive at your address
                        the same day.
                    </p>
                </div>
            </div>
            <div class="faq-item rounded-2xl border border-border bg-card group">
                ...
                <div
                    class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        We deliver couriers and parcels from Jaipur to all major Tier-1, Tier-2, and Tier-3 cities in India,
                        including Delhi, Mumbai, Pune, Ahmedabad, Hyderabad, Kolkata, Chennai, Indore, Lucknow, and
                        Bangalore.
                    </p>
                </div>
            </div>
            <div class="faq-item rounded-2xl border border-border bg-card group">
                ...
                <div
                    class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        Express air deliveries to major metro areas usually arrive within 24 to 48 hours. Other cities and
                        remote surface transport routes across India take 2 to 5 business days.
                    </p>
                </div>
            </div>
        </div>
