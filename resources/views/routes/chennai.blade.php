...
@push('meta')
    <title>Jaipur to Chennai Courier Service | Luggage Relocation</title>
    <meta name="description" content="Best Jaipur to Chennai courier, luggage shifting, and cargo services. Secure packaging, direct air cargo, doorstep pickup, and live tracking.">
    <meta name="keywords" content="jaipur to chennai courier service, courier from jaipur to chennai, luggage shifting jaipur to chennai, cargo service jaipur to chennai, parcel delivery jaipur to chennai, courier charges jaipur to chennai">
    <meta property="og:title" content="Jaipur to Chennai Courier Service | Luggage Relocation">
    <meta property="og:description" content="Best Jaipur to Chennai courier, luggage shifting, and cargo services. Secure packaging, direct air cargo, doorstep pickup, and live tracking.">
    <meta name="twitter:title" content="Jaipur to Chennai Courier Service | Luggage Relocation">
    <meta name="twitter:description" content="Best Jaipur to Chennai courier, luggage shifting, and cargo services. Secure packaging, direct air cargo, doorstep pickup, and live tracking.">
@endpush
...
@section('content')
    ...
    <section class="relative overflow-hidden bg-hero-gradient text-white">
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
            <div class="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-bold uppercase tracking-wider backdrop-blur animate-pulse">
                <x-icons.map-pin class="text-gold" /> Serving Chennai Metro & OMR
            </div>
            <h1 class="mt-4 text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">
                Jaipur to Chennai <span class="text-gold">Courier & Cargo</span>
            </h1>
            <p class="mt-4 text-white/85 sm:text-lg max-w-3xl">
                Need to transport personal computers, household boxes, student books, or commercial consignments from Jaipur to Chennai? JM Courier offers quick, secure doorstep shipping solutions.
            </p>
            <div class="mt-7 flex flex-wrap gap-3">
                <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20book%20a%20pickup%20from%20Jaipur%20to%20Chennai."
                    ...
                    <x-icons.whatsapp class="w-5 h-5" /> Chat on WhatsApp
                </a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div class="space-y-6">
                <div class="mb-3 inline-flex rounded-full bg-accent px-3 py-1 text-xs font-bold uppercase tracking-wider text-brand">
                    Jaipur to Chennai Corridor
                </div>
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                    Reliable Luggage & Courier Shifting to Chennai
                </h2>
                <div class="space-y-4 text-foreground/85 text-sm sm:text-base leading-relaxed">
                    <p>
                        Chennai, the gateway to South India and a primary IT and automobile center, receives high volumes of logistics traffic from Jaipur. Whether it's textile businesses shipping Jaipur block prints to retailers in T. Nagar, IT workers relocating to OMR (Old Mahabalipuram Road), or students moving to IIT Madras or Anna University, reliable shipping is essential.
                    </p>
                    <p>
                        At <strong>JM Courier</strong>, we bridge this long distance by providing premium, end-to-end <strong>Jaipur to Chennai courier services</strong>. We handle everything from document envelopes to student relocation boxes and B2B commercial cargo.
                    </p>
                    <p>
                        We collect from all corners of Jaipur (Mansarovar, Vaishali Nagar, Jhotwara, Jagatpura, Malviya Nagar, Bani Park, Sanganer, Sitapura, Pratap Nagar) and deliver directly to Chennai areas including Adyar, T. Nagar, OMR, Guindy, Velachery, Ambattur, Mylapore, and central business locations. Our priority air cargo ensures arrival in 1 to 2 days.
                    </p>
                </div>
                <div class="flex flex-wrap gap-3 pt-2">
                    ...
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-xs">
                        <x-icons.circle-check class="text-brand w-4 h-4 shrink-0" /> Air Express (24-48 Hours)
                    </div>
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-xs">
                        <x-icons.circle-check class="text-brand w-4 h-4 shrink-0" /> Triple-Layer Bubble Wrap
                    </div>
                </div>
            </div>
            <div class="relative rounded-3xl overflow-hidden border border-border bg-card p-8 shadow-soft">
                <h3 class="text-xl font-extrabold text-navy mb-4">Chennai Route Shipping Specialities</h3>
                <ul class="space-y-4">
                    <li class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Moving books, clothing, PCs, desktops, monitors, and kitchen items safely to tech corridor apartments.</p>
                        </div>
                    </li>
                    <li class="flex gap-3">
                        <div class="h-6 w-6 rounded-full bg-accent text-brand flex items-center justify-center shrink-0 font-bold text-sm">2</div>
                        <div>
                            <h4 class="font-bold text-navy text-sm sm:text-base">IIT Madras Student Relocation</h4>
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Shipping textbooks, suitcases, bedding, and studies stuff directly to PG or hostel rooms.</p>
                        </div>
                    </li>
                    <li class="flex gap-3">
                        <div class="h-6 w-6 rounded-full bg-accent text-brand flex items-center justify-center shrink-0 font-bold text-sm">3</div>
                        <div>
                            <h4 class="font-bold text-navy text-sm sm:text-base">Textile & Handicrafts Shipping</h4>
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Bulk cargo transport of block prints, handicrafts, and kurtis to Chennai retail hubs.</p>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div class="grid gap-12 lg:grid-cols-2 items-center">
            <div>
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Jaipur to Chennai Transit Times</h2>
                <p class="mt-3 text-muted-foreground text-sm sm:text-base leading-relaxed">
                    Select the transport velocity that meets your specific college registration dates or OMR joining schedules.
                </p>
            ...
            <div class="rounded-3xl bg-brand-gradient p-8 text-white shadow-elevated relative overflow-hidden">
                ...
                <p class="mt-2 text-white/85 text-sm sm:text-base leading-relaxed">
                    We offer dedicated promotional tariffs for students and corporate employees moving their households to Chennai. Contact us to avail special route discounts.
                </p>
                <div class="mt-6 flex flex-wrap gap-3">
                    <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20know%20shipping%20rates%20from%20Jaipur%20to%20Chennai."
        ...
        <div class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
            <div class="mx-auto text-center max-w-2xl">
                ...
                <p class="mt-2 text-muted-foreground text-sm sm:text-base">
                    Engineered to deliver convenience, safety, and rapid transit from Jaipur to Chennai.
                </p>
            </div>
            ...
            <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">
                        Utilizing regular direct flights from Jaipur Airport to Chennai (MAA) for rapid delivery.
                    </p>
                </div>
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    <div class="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-accent text-brand">
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 bg-secondary/30 rounded-3xl mb-12">
        <div class="mx-auto text-center max-w-2xl">
            ...
            <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Jaipur to Chennai Shipping FAQs</h2>
        </div>
        ...
        <div class="mx-auto mt-8 max-w-3xl space-y-2 overflow-hidden px-4">
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>What is the transit time from Jaipur to Chennai?</span>
            ...
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>Do you offer home pickup in Jaipur for Chennai packages?</span>
                    <x-icons.plus class="h-4 w-4 shrink-0 text-brand transition duration-300 ease-out group-[.is-open]:rotate-45" />
                </button>
                <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
