...
@push('meta')
    <title>Jaipur to Hyderabad Courier Service | Luggage Transport</title>
    <meta name="description" content="Affordable Jaipur to Hyderabad courier, luggage transport, and cargo shifting services. Fast air express, doorstep pickup, & secure packaging.">
    <meta name="keywords" content="jaipur to hyderabad courier service, courier from jaipur to hyderabad, luggage shifting jaipur to hyderabad, cargo service jaipur to hyderabad, parcel delivery jaipur to hyderabad, cheap courier jaipur to hyderabad">
    <meta property="og:title" content="Jaipur to Hyderabad Courier Service | Luggage Transport">
    <meta property="og:description" content="Affordable Jaipur to Hyderabad courier, luggage transport, and cargo shifting services. Fast air express, doorstep pickup, & secure packaging.">
    <meta name="twitter:title" content="Jaipur to Hyderabad Courier Service | Luggage Transport">
    <meta name="twitter:description" content="Affordable Jaipur to Hyderabad courier, luggage transport, and cargo shifting services. Fast air express, doorstep pickup, & secure packaging.">
@endpush
...
@section('content')
    ...
    <section class="relative overflow-hidden bg-hero-gradient text-white">
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
            <div class="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-bold uppercase tracking-wider backdrop-blur animate-pulse">
                <x-icons.map-pin class="text-gold" /> Daily South India Flights
            </div>
            <h1 class="mt-4 text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">
                Jaipur to Hyderabad <span class="text-gold">Courier & Cargo</span>
            </h1>
            <p class="mt-4 text-white/85 sm:text-lg max-w-3xl">
                Looking for a secure, fast, and budget-friendly way to ship personal luggage, business packages, or machinery to Hyderabad? Experience door-to-door express delivery with JM Courier.
            </p>
            <div class="mt-7 flex flex-wrap gap-3">
                <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20book%20a%20pickup%20from%20Jaipur%20to%20Hyderabad."
                    ...
                    <x-icons.whatsapp class="w-5 h-5" /> WhatsApp Booking Desk
                </a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div class="space-y-6">
                <div class="mb-3 inline-flex rounded-full bg-accent px-3 py-1 text-xs font-bold uppercase tracking-wider text-brand">
                    Jaipur to Deccan Corridor
                </div>
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                    Reliable Luggage & Courier Shifting to Hyderabad
                </h2>
                <div class="space-y-4 text-foreground/85 text-sm sm:text-base leading-relaxed">
                    <p>
                        Hyderabad, the City of Pearls and one of India's top IT and pharmaceutical centers, shares a high volume of relocation and business transport traffic with Jaipur. Every month, students, IT professionals, and trade houses require a dependable service to ship electronics, documents, luggage, and commercial consignments between these two major cities.
                    </p>
                    <p>
                        At <strong>JM Courier</strong>, we address this demand with our specialized <strong>Jaipur to Hyderabad courier services</strong>. We operate free daily pickups from all major localities in Jaipur (Mansarovar, Vaishali Nagar, Jhotwara, Jagatpura, Malviya Nagar, Bani Park, Sanganer, Sitapura, Pratap Nagar) and routes to Hyderabad.
                    </p>
                    <p>
                        We deliver directly to all parts of Hyderabad, including IT clusters (Gachibowli, HITEC City, Madhapur, Kondapur), academic areas (Ameerpet, Secunderabad, Osmania University), and upscale residential regions (Jubilee Hills, Banjara Hills). Our direct air routing ensures express packages arrive in Hyderabad within 1 to 2 days.
                    </p>
                </div>
                <div class="flex flex-wrap gap-3 pt-2">
                    ...
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-xs">
                        <x-icons.circle-check class="text-brand w-4 h-4 shrink-0" /> Fast Air Cargo (24-48 Hours)
                    </div>
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-xs">
                        <x-icons.circle-check class="text-brand w-4 h-4 shrink-0" /> Live WhatsApp Updates
                    </div>
                </div>
            </div>
            <div class="relative rounded-3xl overflow-hidden border border-border bg-card p-8 shadow-soft">
                <h3 class="text-xl font-extrabold text-navy mb-4">Hyderabad Route Specialities</h3>
                <ul class="space-y-4">
                    <li class="flex gap-3">
                        <div class="h-6 w-6 rounded-full bg-accent text-brand flex items-center justify-center shrink-0 font-bold text-sm">1</div>
                        <div>
                            <h4 class="font-bold text-navy text-sm sm:text-base">IT Employee Baggage Relocation</h4>
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Moving screens, CPUs, household essentials, wardrobes, and kitchen packages to cyber corridor apartments.</p>
                        </div>
                    </li>
                    <li class="flex gap-3">
                        <div class="h-6 w-6 rounded-full bg-accent text-brand flex items-center justify-center shrink-0 font-bold text-sm">2</div>
                        <div>
                            <h4 class="font-bold text-navy text-sm sm:text-base">B2B Textiles & Handicrafts</h4>
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Shipping Jaipuri block prints, kurtis, bedsheets, and heritage crafts to wholesalers in Hyderabad.</p>
                        </div>
                    </li>
                    <li class="flex gap-3">
                        <div class="h-6 w-6 rounded-full bg-accent text-brand flex items-center justify-center shrink-0 font-bold text-sm">3</div>
                        <div>
                            <h4 class="font-bold text-navy text-sm sm:text-base">Confidential Business Courier</h4>
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Legal files, trade invoices, tender papers, and high-value tech devices flown securely.</p>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div class="grid gap-12 lg:grid-cols-2 items-center">
            <div>
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Jaipur to Hyderabad Transit & Timelines</h2>
                <p class="mt-3 text-muted-foreground text-sm sm:text-base leading-relaxed">
                    Given the distance between Rajasthan and Telangana, select the transit route that matches your timeline requirements.
                </p>
                    ...
                    <table class="w-full text-left text-sm">
                        ...
                        <tbody class="divide-y divide-border">
                            <tr class="hover:bg-accent/45 transition">
                                ...
                                <td class="p-4 text-muted-foreground">Urgent Files, Medicines, Small Electronics</td>
                            </tr>
                            <tr class="hover:bg-accent/45 transition">
            ...
            <div class="rounded-3xl bg-brand-gradient p-8 text-white shadow-elevated relative overflow-hidden">
                ...
                <p class="mt-2 text-white/85 text-sm sm:text-base leading-relaxed">
                    We offer dedicated promotional tariffs for students and corporate employees moving their households to Hyderabad. Contact us to avail special route discounts.
                </p>
                <div class="mt-6 flex flex-wrap gap-3">
                    <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20know%20shipping%20rates%20from%20Jaipur%20to%20Hyderabad."
                    ...
                    <a href="tel:+91{{ config('services.info.phone') }}"
                        ...
                        <x-icons.phone class="w-4 h-4" /> Call Helpline
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
            <div class="mx-auto text-center max-w-2xl">
                ...
                <p class="mt-2 text-muted-foreground text-sm sm:text-base">
                    Engineered to deliver convenience, safety, and rapid transit from Jaipur to Hyderabad.
                </p>
            </div>
            ...
            <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">
                        Utilizing regular direct flights from Jaipur Airport to Hyderabad (RGIA) for rapid delivery.
                    </p>
                </div>
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    <div class="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-accent text-brand">
                ...
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    ...
                    <h3 class="mt-4 font-bold text-navy">Human Desk Desk</h3>
                    <p class="mt-1 text-sm text-muted-foreground">
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 bg-secondary/30 rounded-3xl mb-12">
        <div class="mx-auto text-center max-w-2xl">
            ...
            <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Jaipur to Hyderabad Shipping FAQs</h2>
        </div>
        ...
        <div class="mx-auto mt-8 max-w-3xl space-y-2 overflow-hidden px-4">
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>What is the transit time from Jaipur to Hyderabad?</span>
            ...
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>Do you offer home pickup in Jaipur for Hyderabad packages?</span>
                    <x-icons.plus class="h-4 w-4 shrink-0 text-brand transition duration-300 ease-out group-[.is-open]:rotate-45" />
                </button>
                <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
            ...
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>How can I ship my college luggage and books to Hyderabad?</span>
                    <x-icons.plus class="h-4 w-4 shrink-0 text-brand transition duration-300 ease-out group-[.is-open]:rotate-45" />
                </button>
                <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        You can book a pickup on WhatsApp. Our team will visit your home, weigh your suitcases and boxes, seal them, and ship them directly to your student PG or hostel in Hyderabad at discounted student rates.
                    </p>
                </div>
            </div>
        </div>
