...
@push('meta')
    <title>Jaipur to Patna Courier Service | Luggage Shifting</title>
    <meta name="description" content="Best Jaipur to Patna courier and luggage shifting service. Free home pickup in Jaipur, premium bubble wrap packing, next-day air courier, & low rates.">
    <meta name="keywords" content="jaipur to patna courier service, courier from jaipur to patna, luggage shifting jaipur to patna, cargo service jaipur to patna, parcel delivery jaipur to patna, cheap courier jaipur to patna">
    <meta property="og:title" content="Jaipur to Patna Courier Service | Luggage Shifting">
    <meta property="og:description" content="Best Jaipur to Patna courier and luggage shifting service. Free home pickup in Jaipur, premium bubble wrap packing, next-day air courier, & low rates.">
    <meta name="twitter:title" content="Jaipur to Patna Courier Service | Luggage Shifting">
    <meta name="twitter:description" content="Best Jaipur to Patna courier and luggage shifting service. Free home pickup in Jaipur, premium bubble wrap packing, next-day air courier, & low rates.">
@endpush
...
@section('content')
    ...
    <section class="relative overflow-hidden bg-hero-gradient text-white">
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
            <div class="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-bold uppercase tracking-wider backdrop-blur animate-pulse">
                <x-icons.map-pin class="text-gold" /> Connecting Rajasthan and Bihar
            </div>
            <h1 class="mt-4 text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">
                Jaipur to Patna <span class="text-gold">Courier & Cargo</span>
            </h1>
            <p class="mt-4 text-white/85 sm:text-lg max-w-3xl">
                Need to dispatch trade goods, personal bags, student materials, or legal files from Jaipur to Patna? Trust our reliable door-to-door courier service with direct tracking.
            </p>
            <div class="mt-7 flex flex-wrap gap-3">
                <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20book%20a%20pickup%20from%20Jaipur%20to%20Patna."
                    ...
                    <x-icons.whatsapp class="w-5 h-5" /> Book Patna Courier
                </a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div class="space-y-6">
                <div class="mb-3 inline-flex rounded-full bg-accent px-3 py-1 text-xs font-bold uppercase tracking-wider text-brand">
                    Bihar Express Connection
                </div>
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                    Seamless Shifting & Document Courier to Patna
                </h2>
                <div class="space-y-4 text-foreground/85 text-sm sm:text-base leading-relaxed">
                    <p>
                        Patna, the ancient and bustling capital city of Bihar, maintains a strong academic and commercial connection with Jaipur. Large numbers of students, traders, and government employees move household belongings, books, textile samples, and court files between Rajasthan and Bihar on a regular basis.
                    </p>
                    <p>
                        At <strong>JM Courier</strong>, we streamline this transit by offering high-efficiency <strong>Jaipur to Patna courier services</strong>. Our professional team collects your parcels directly from your residence or office anywhere in Jaipur (Mansarovar, Vaishali Nagar, Jhotwara, Jagatpura, Malviya Nagar, Bani Park, Sanganer, Sitapura) with no pickup charges.
                    </p>
                    <p>
                        We deliver directly to all parts of Patna, including central commercial areas like Boring Road and Fraser Road, major residential regions like Kankarbagh and Bailey Road, and industrial nodes like Danapur and Patna Saheb. Our priority air routing ensures express packages arrive in Patna in 1 to 2 days.
                    </p>
                </div>
                <div class="flex flex-wrap gap-3 pt-2">
                    ...
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-xs">
                        <x-icons.circle-check class="text-brand w-4 h-4 shrink-0" /> Waterproof Multi-Layer Wrapping
                    </div>
                </div>
            </div>
            <div class="relative rounded-3xl overflow-hidden border border-border bg-card p-8 shadow-soft">
                <h3 class="text-xl font-extrabold text-navy mb-4">Patna Route Shipping Specialities</h3>
                <ul class="space-y-4">
                    <li class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Moving books, clothing suitcases, and study materials for students transitioning between Patna and coaching hubs in Rajasthan.</p>
                        </div>
                    </li>
                    <li class="flex gap-3">
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div class="grid gap-12 lg:grid-cols-2 items-center">
            <div>
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Jaipur to Patna Transit Times</h2>
            ...
            <div class="rounded-3xl bg-brand-gradient p-8 text-white shadow-elevated relative overflow-hidden">
                ...
                <p class="mt-2 text-white/85 text-sm sm:text-base leading-relaxed">
                    We offer dedicated promotional tariffs for students and corporate employees moving their households to Patna. Contact us to avail special route discounts.
                </p>
                <div class="mt-6 flex flex-wrap gap-3">
                    <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20know%20shipping%20rates%20from%20Jaipur%20to%20Patna."
        ...
        <div class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
            <div class="mx-auto text-center max-w-2xl">
                ...
                <p class="mt-2 text-muted-foreground text-sm sm:text-base">
                    Engineered to deliver convenience, safety, and rapid transit from Jaipur to Patna.
                </p>
            </div>
            ...
            <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">
                        Utilizing regular direct flights from Jaipur Airport to Patna (PAT) for rapid delivery.
                    </p>
                </div>
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    <div class="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-accent text-brand">
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 bg-secondary/30 rounded-3xl mb-12">
        <div class="mx-auto text-center max-w-2xl">
            ...
            <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Jaipur to Patna Shipping FAQs</h2>
        </div>
        ...
        <div class="mx-auto mt-8 max-w-3xl space-y-2 overflow-hidden px-4">
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>What is the transit time from Jaipur to Patna?</span>
            ...
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>Do you offer home pickup in Jaipur for Patna packages?</span>
                    <x-icons.plus class="h-4 w-4 shrink-0 text-brand transition duration-300 ease-out group-[.is-open]:rotate-45" />
                </button>
                <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
