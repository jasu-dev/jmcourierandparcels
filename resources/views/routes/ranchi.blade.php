...
@push('meta')
    <title>Jaipur to Ranchi Courier Service | Luggage Transport</title>
    <meta name="description" content="Affordable Jaipur to Ranchi courier, luggage transport, and cargo shipping. Door-to-door pickup, secure multi-layer packing, and live WhatsApp updates.">
    <meta name="keywords" content="jaipur to ranchi courier service, courier from jaipur to ranchi, luggage shifting jaipur to ranchi, cargo service jaipur to ranchi, parcel delivery jaipur to ranchi, door to door courier jaipur to ranchi">
    <meta property="og:title" content="Jaipur to Ranchi Courier Service | Luggage Transport">
    <meta property="og:description" content="Affordable Jaipur to Ranchi courier, luggage transport, and cargo shipping. Door-to-door pickup, secure multi-layer packing, and live WhatsApp updates.">
    <meta name="twitter:title" content="Jaipur to Ranchi Courier Service | Luggage Transport">
    <meta name="twitter:description" content="Affordable Jaipur to Ranchi courier, luggage transport, and cargo shipping. Door-to-door pickup, secure multi-layer packing, and live WhatsApp updates.">
@endpush
...
@section('content')
    ...
    <section class="relative overflow-hidden bg-hero-gradient text-white">
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
            <div class="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-bold uppercase tracking-wider backdrop-blur animate-pulse">
                <x-icons.map-pin class="text-gold" /> Serving Jharkhand Corridor
            </div>
            <h1 class="mt-4 text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">
                Jaipur to Ranchi <span class="text-gold">Courier & Cargo</span>
            </h1>
            <p class="mt-4 text-white/85 sm:text-lg max-w-3xl">
                Need to ship household luggage, corporate documents, or B2B commercial cargo from Jaipur to Ranchi? Rely on JM Courier for fast, secure, and budget-friendly door-to-door shipping.
            </p>
            <div class="mt-7 flex flex-wrap gap-3">
                <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20book%20a%20pickup%20from%20Jaipur%20to%20Ranchi."
                    ...
                    <x-icons.whatsapp class="w-5 h-5" /> Book Ranchi Pickup
                </a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div class="space-y-6">
                ...
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                    Reliable Door-to-Door Logistics from Jaipur to Ranchi
                </h2>
                <div class="space-y-4 text-foreground/85 text-sm sm:text-base leading-relaxed">
                    <p>
                        Ranchi, the capital of Jharkhand and a major industrial hub of Eastern India, maintains active student, corporate, and trading relations with Jaipur. Many families, mining executives, government officers, and students require a trusted logistics partner to transport documents, luggage, clothes, and heavy items between Rajasthan and Ranchi.
                    </p>
                    <p>
                        At <strong>JM Courier</strong>, we streamline this transit by offering dependable, end-to-end <strong>Jaipur to Ranchi courier services</strong>. Our professional team collects your parcels directly from your doorstep anywhere in Jaipur (Mansarovar, Vaishali Nagar, Jhotwara, Jagatpura, Malviya Nagar, Bani Park, Sanganer, Sitapura, Pratap Nagar) with no additional collection charges.
                    </p>
                    <p>
                        Our logistics channel covers all locations in Ranchi, including educational sectors, commercial zones like Lalpur, Doranda, Hindpiri, Hatia, Bariatu, Kanke Road, and Kokar. We utilize both fast air cargo options and express road transport networks to ensure safe, damage-free delivery.
                    </p>
                </div>
                <div class="flex flex-wrap gap-3 pt-2">
                    ...
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-xs">
                        <x-icons.circle-check class="text-brand w-4 h-4 shrink-0" /> Waterproof Secure Packaging
                    </div>
                </div>
            </div>
            <div class="relative rounded-3xl overflow-hidden border border-border bg-card p-8 shadow-soft">
                <h3 class="text-xl font-extrabold text-navy mb-4">Ranchi Route Shipping Specialities</h3>
                <ul class="space-y-4">
                    <li class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Moving textbooks, suitcases, bedding, study desks, and laptops directly from Jaipur homes to Ranchi PGs or hostels.</p>
                        </div>
                    </li>
                    <li class="flex gap-3">
                        <div class="h-6 w-6 rounded-full bg-accent text-brand flex items-center justify-center shrink-0 font-bold text-sm">2</div>
                        <div>
                            <h4 class="font-bold text-navy text-sm sm:text-base">Industrial & B2B Shipments</h4>
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Shipping mechanical parts, steel trading documents, electrical spares, and commercial goods safely.</p>
                        </div>
                    </li>
                    <li class="flex gap-3">
                        <div class="h-6 w-6 rounded-full bg-accent text-brand flex items-center justify-center shrink-0 font-bold text-sm">3</div>
                        <div>
                            <h4 class="font-bold text-navy text-sm sm:text-base">Express Document Delivery</h4>
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Confidential courier for academic forms, legal files, trade contracts, and tender documents.</p>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div class="grid gap-12 lg:grid-cols-2 items-center">
            <div>
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Jaipur to Ranchi Transit Times</h2>
                <p class="mt-3 text-muted-foreground text-sm sm:text-base leading-relaxed">
                    Choose the transport velocity that meets your specific college registration dates or business deadlines.
                </p>
            ...
            <div class="rounded-3xl bg-brand-gradient p-8 text-white shadow-elevated relative overflow-hidden">
                ...
                <p class="mt-2 text-white/85 text-sm sm:text-base leading-relaxed">
                    We offer dedicated promotional tariffs for students and corporate employees moving their households to Ranchi. Contact us to avail special route discounts.
                </p>
                <div class="mt-6 flex flex-wrap gap-3">
                    <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20know%20shipping%20rates%20from%20Jaipur%20to%20Ranchi."
        ...
        <div class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
            <div class="mx-auto text-center max-w-2xl">
                ...
                <p class="mt-2 text-muted-foreground text-sm sm:text-base">
                    Engineered to deliver convenience, safety, and rapid transit from Jaipur to Ranchi.
                </p>
            </div>
            ...
            <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">
                        Utilizing regular direct flights from Jaipur Airport to Ranchi (IXR) for rapid delivery.
                    </p>
                </div>
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    <div class="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-accent text-brand">
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 bg-secondary/30 rounded-3xl mb-12">
        <div class="mx-auto text-center max-w-2xl">
            ...
            <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Jaipur to Ranchi Shipping FAQs</h2>
        </div>
        ...
        <div class="mx-auto mt-8 max-w-3xl space-y-2 overflow-hidden px-4">
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>What is the transit time from Jaipur to Ranchi?</span>
            ...
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>Do you offer home pickup in Jaipur for Ranchi packages?</span>
                    <x-icons.plus class="h-4 w-4 shrink-0 text-brand transition duration-300 ease-out group-[.is-open]:rotate-45" />
                </button>
                <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
