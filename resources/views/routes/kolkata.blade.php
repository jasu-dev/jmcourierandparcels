...
@section('content')
        ...
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
            ...
            <div class="mt-7 flex flex-wrap gap-3">
                <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20book%20a%20pickup%20from%20Jaipur%20to%20Kolkata."
                    ...
                    <x-icons.whatsapp class="w-5 h-5" /> Book Kolkata Pickup
                </a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div class="space-y-6">
                ...
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                    Reliable Door-to-Door Logistics from Jaipur to Kolkata
                </h2>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div class="grid gap-12 lg:grid-cols-2 items-center">
            <div>
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Jaipur to Kolkata Transit Times</h2>
            ...
            <div class="rounded-3xl bg-brand-gradient p-8 text-white shadow-elevated relative overflow-hidden">
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20know%20shipping%20rates%20from%20Jaipur%20to%20Kolkata."
                        ...
                        <x-icons.whatsapp class="w-4 h-4" /> WhatsApp Price Check
                    </a>
                    <a href="tel:+91{{ config('services.info.phone') }}"
        ...
        <div class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
            <div class="mx-auto text-center max-w-2xl">
                ...
                <p class="mt-2 text-muted-foreground text-sm sm:text-base">
                    Engineered to deliver convenience, safety, and rapid transit from Jaipur to Kolkata.
                </p>
            </div>
            ...
            <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    ...
                    <h3 class="mt-4 font-bold text-navy">Flight Routing</h3>
                    <p class="mt-1 text-sm text-muted-foreground">
                        Utilizing regular direct flights from Jaipur Airport to Kolkata (CCU) for rapid delivery.
                    </p>
                </div>
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    <div class="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-accent text-brand">
