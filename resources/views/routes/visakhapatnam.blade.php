...
@push('meta')
    <title>Jaipur to Visakhapatnam Courier | Insured Shifting</title>
    <meta name="description" content="Express Jaipur to Visakhapatnam (Vizag) courier, luggage shifting, and cargo services. Secure packaging, door-to-door delivery, and live tracking.">
    <meta name="keywords" content="jaipur to visakhapatnam courier service, courier from jaipur to visakhapatnam, luggage shifting jaipur to visakhapatnam, cargo service jaipur to visakhapatnam, parcel delivery jaipur to visakhapatnam, vizag courier charges jaipur">
    <meta property="og:title" content="Jaipur to Visakhapatnam Courier | Insured Shifting">
    <meta property="og:description" content="Express Jaipur to Visakhapatnam (Vizag) courier, luggage shifting, and cargo services. Secure packaging, door-to-door delivery, and live tracking.">
    <meta name="twitter:title" content="Jaipur to Visakhapatnam Courier | Insured Shifting">
    <meta name="twitter:description" content="Express Jaipur to Visakhapatnam (Vizag) courier, luggage shifting, and cargo services. Secure packaging, door-to-door delivery, and live tracking.">
@endpush
...
@section('content')
    ...
    <section class="relative overflow-hidden bg-hero-gradient text-white">
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
            <div class="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-bold uppercase tracking-wider backdrop-blur animate-pulse">
                <x-icons.map-pin class="text-gold" /> Connect with Port City Vizag
            </div>
            <h1 class="mt-4 text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">
                Jaipur to Visakhapatnam <span class="text-gold">Courier & Cargo</span>
            </h1>
            <p class="mt-4 text-white/85 sm:text-lg max-w-3xl">
                Shipping heavy industrial parts, personal relocation luggage, or business documents from Jaipur to Visakhapatnam? Count on JM Courier for safe, speed-driven door-to-door logistics.
            </p>
            <div class="mt-7 flex flex-wrap gap-3">
                <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20book%20a%20pickup%20from%20Jaipur%20to%20Visakhapatnam."
                    ...
                    <x-icons.whatsapp class="w-5 h-5" /> Book Vizag Shipping
                </a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div class="space-y-6">
                ...
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                    Reliable Luggage & Courier Shifting to Visakhapatnam (Vizag)
                </h2>
                <div class="space-y-4 text-foreground/85 text-sm sm:text-base leading-relaxed">
                    <p>
                        Visakhapatnam (Vizag), the largest city and financial capital of Andhra Pradesh, has an active commercial connection with Rajasthan. Many industrial companies, steel wholesalers, shipyard executives, and educational professionals move household assets, machinery samples, and documents between Jaipur and the coastal hub of Vizag.
                    </p>
                    <p>
                        At <strong>JM Courier</strong>, we manage this long-distance route by providing reliable <strong>Jaipur to Visakhapatnam courier services</strong>. Our professional crew collects your packages directly from your residence or office anywhere in Jaipur (Mansarovar, Vaishali Nagar, Jhotwara, Jagatpura, Malviya Nagar, Bani Park, Sanganer, Sitapura) with no pickup fee.
                    </p>
                    <p>
                        We guarantee fast-track deliveries to all key neighborhoods in Visakhapatnam, including industrial nodes like Gajuwaka and steel plant sectors, commercial areas like Dwaraka Nagar and Jagadamba Centre, and residential suburbs like MVP Colony and Madhurawada. Our direct air routing ensures express packages reach Visakhapatnam in 1 to 2 days.
                    </p>
                </div>
                <div class="flex flex-wrap gap-3 pt-2">
                    ...
                    <div class="flex items-center gap-2 rounded-xl border border-border bg-card p-3 font-semibold text-navy text-xs">
                        <x-icons.circle-check class="text-brand w-4 h-4 shrink-0" /> GPS Barcode Tracking
                    </div>
                </div>
            </div>
            <div class="relative rounded-3xl overflow-hidden border border-border bg-card p-8 shadow-soft">
                <h3 class="text-xl font-extrabold text-navy mb-4">Visakhapatnam Route Shipping Specialities</h3>
                <ul class="space-y-4">
                    <li class="flex gap-3">
                        <div class="h-6 w-6 rounded-full bg-accent text-brand flex items-center justify-center shrink-0 font-bold text-sm">1</div>
                        <div>
                            <h4 class="font-bold text-navy text-sm sm:text-base">Industrial Cargo & Equipment</h4>
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Bulk transportation of auto spares, brass items, and machinery tools from Sitapura and Vishwakarma industrial zones in Jaipur.</p>
                        </div>
                    </li>
                    <li class="flex gap-3">
                        <div class="h-6 w-6 rounded-full bg-accent text-brand flex items-center justify-center shrink-0 font-bold text-sm">2</div>
                        <div>
                            <h4 class="font-bold text-navy text-sm sm:text-base">Household Shifting & Luggage</h4>
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Shipping suitcases, moving boxes, domestic appliances, and wardrobes safely for military or corporate relocations.</p>
                        </div>
                    </li>
                    <li class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs sm:text-sm text-muted-foreground mt-0.5">Express courier for trade contracts, legal agreements, government bids, and sample catalogs.</p>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div class="grid gap-12 lg:grid-cols-2 items-center">
            <div>
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Jaipur to Visakhapatnam Transit & Timelines</h2>
                <p class="mt-3 text-muted-foreground text-sm sm:text-base leading-relaxed">
                    Given the distance to the coastal region, we prioritize air freight networks to manage fast timelines.
                </p>
            ...
            <div class="rounded-3xl bg-brand-gradient p-8 text-white shadow-elevated relative overflow-hidden">
                ...
                <p class="mt-2 text-white/85 text-sm sm:text-base leading-relaxed">
                    We offer dedicated promotional tariffs for students and corporate employees moving their households to Visakhapatnam. Contact us to avail special route discounts.
                </p>
                <div class="mt-6 flex flex-wrap gap-3">
                    <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20know%20shipping%20rates%20from%20Jaipur%20to%20Visakhapatnam."
        ...
        <div class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
            <div class="mx-auto text-center max-w-2xl">
                ...
                <p class="mt-2 text-muted-foreground text-sm sm:text-base">
                    Engineered to deliver convenience, safety, and rapid transit from Jaipur to Visakhapatnam.
                </p>
            </div>
            ...
            <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    ...
                    <h3 class="mt-4 font-bold text-navy">Air Connectivity</h3>
                    <p class="mt-1 text-sm text-muted-foreground">
                        Utilizing regular direct flights from Jaipur Airport to Vizag (VTZ) for rapid delivery.
                    </p>
                </div>
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    <div class="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-accent text-brand">
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 bg-secondary/30 rounded-3xl mb-12">
        <div class="mx-auto text-center max-w-2xl">
            ...
            <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Jaipur to Visakhapatnam Shipping FAQs</h2>
        </div>
        ...
        <div class="mx-auto mt-8 max-w-3xl space-y-2 overflow-hidden px-4">
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>What is the transit time from Jaipur to Visakhapatnam?</span>
            ...
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>Do you offer home pickup in Jaipur for Visakhapatnam packages?</span>
                    <x-icons.plus class="h-4 w-4 shrink-0 text-brand transition duration-300 ease-out group-[.is-open]:rotate-45" />
                </button>
                <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
