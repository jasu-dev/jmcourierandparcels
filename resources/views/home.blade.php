        ...
        <div class="overflow-hidden rounded-3xl bg-hero-gradient p-8 text-white shadow-elevated sm:p-12">
            <div class="grid items-center gap-6 md:grid-cols-[1fr_auto]">
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="/pricing"
                        class="inline-flex items-center gap-2 rounded-full bg-gold-gradient px-6 py-3 font-bold text-gold-foreground shadow-soft">
                        <x-icons.phone class="w-4 h-4" />
                        Get Quote
                    </a>
                    <a href="https://wa.me/919000000000"
                        class="inline-flex items-center gap-2 rounded-full bg-white/10 px-6 py-3 font-bold ring-1 ring-white/30 backdrop-blur hover:bg-white/20">
