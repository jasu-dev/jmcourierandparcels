...
@push('meta')
    <title>Best Courier & Cargo Services in Jagatpura Jaipur | JM Courier</title>
    <meta name="description"
        content="Reliable & fast domestic courier, parcel delivery, luggage transport, and cargo services in Jagatpura, Jaipur. Same-day free doorstep pickup & express shipping to all India.">
    <meta name="keywords"
        content="courier service jagatpura jaipur, cargo services jagatpura, luggage transport jagatpura, parcel delivery jagatpura, express delivery jaipur jagatpura, jagatpura courier collection, document courier jagatpura">
    <meta property="og:title" content="Best Courier & Cargo Services in Jagatpura Jaipur | JM Courier">
    <meta property="og:description"
        content="Reliable & fast domestic courier, parcel delivery, luggage transport, and cargo services in Jagatpura, Jaipur. Same-day free doorstep pickup & express shipping to all India.">
    <meta name="twitter:title" content="Best Courier & Cargo Services in Jagatpura Jaipur | JM Courier">
...
@section('content')
    ...
    <section class="relative overflow-hidden bg-hero-gradient text-white">
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
            <div
                ...
                <x-icons.map-pin class="text-gold" /> Serving Jagatpura, Jaipur
            </div>
            <h1 class="mt-4 text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">
                Courier & Cargo Services in <span class="text-gold">Jagatpura, Jaipur</span>
            </h1>
            <p class="mt-4 text-white/85 sm:text-lg max-w-3xl">
                Send documents, parcels, student luggage, or commercial cargo from Jagatpura to any destination across
                India. Enjoy hassle-free door-to-door delivery, free same-day pickup, and tracking at highly competitive rates.
            </p>
            <div class="mt-7 flex flex-wrap gap-3">
                <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20book%20a%20pickup%20from%20Jagatpura%20Jaipur."
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div class="space-y-6">
                ...
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                    Reliable Door-to-Door Courier Collection in Jagatpura
                </h2>
                <div class="space-y-4 text-foreground/85 text-sm sm:text-base leading-relaxed">
                    <p>
                        Jagatpura has grown into one of Jaipur's premier educational and residential hubs.
                        Whether you are a student relocation candidate shifting luggage from a PG near SKIT or Gyan Vihar, a family in NRI Colony sending festive parcels, or an office near Mahal Road dispatching corporate documents, <b>JM Courier</b> is here to help.
                    </p>
                    <p>
                        We offer a comprehensive suite of logistics services tailored for Jagatpura. Our expert team
                    ...
                    <p>
                        With regular routes spanning Mahal Road, NRI Colony, Akshay Patra Area, Jagatpura Railway Station, Ramnagariya, and CBI Colony, our field executives can reach your location within minutes of booking.
                    </p>
                </div>
            ...
            <div class="flex items-center justify-center">
                <img src="{{ asset('images/cities/jagatpura.png') }}" alt="JM Courier Jagatpura" class="rounded-3xl shadow-soft border border-border max-w-full h-auto">
            </div>
        </div>
    </section>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 pb-16 sm:px-6 sm:pb-20">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div class="overflow-hidden rounded-3xl border border-border bg-card shadow-soft aspect-[3/2]">
                <img src="{{ asset('images/cities/jagatpura_1.png') }}" 
                     alt="Jagatpura Jaipur Local Landmark" 
                     class="w-full h-full object-cover hover:scale-105 transition duration-500"
                     loading="lazy">
            </div>
            <div class="overflow-hidden rounded-3xl border border-border bg-card shadow-soft aspect-[3/2]">
                <img src="{{ asset('images/cities/jagatpura_2.png') }}" 
                     alt="Jagatpura Jaipur Local Vibe" 
                     class="w-full h-full object-cover hover:scale-105 transition duration-500"
                     loading="lazy">
            </div>
        </div>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 pb-16 sm:px-6 sm:pb-20">
        <div class="mx-auto text-center max-w-3xl mb-12">
            ...
            <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                Premium Logistics & Shifting Services in Jagatpura
            </h2>
            ...
            <div
                ...
                <div>
                    ...
                    <p class="mt-4 text-sm text-muted-foreground leading-relaxed">
                        Are you looking for reliable <b>door-to-door express courier collection in Jagatpura</b>? We
                    ...
                    <ul class="mt-4 space-y-2 text-xs sm:text-sm text-muted-foreground">
                        <li class="flex items-center gap-2">
                            ...
                            Same-day urgent document courier services in Jagatpura Jaipur.
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
                ...
                <div>
                    ...
                    <p class="mt-4 text-sm text-muted-foreground leading-relaxed">
                        Optimize your business distribution with high-quality <b>heavy machinery & retail goods transport in
                            Jagatpura Jaipur</b>. We support manufacturers, local retailers, and wholesalers with
                    ...
                    <ul class="mt-4 space-y-2 text-xs sm:text-sm text-muted-foreground">
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
                            Bulk commercial cargo and parcel booking in Jagatpura.
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
                ...
                <div>
                    ...
                    <p class="mt-4 text-sm text-muted-foreground leading-relaxed">
                        Relocating out of a hostel or rental room? Use our dedicated <b>hostel and PG baggage transport in
                            Jagatpura</b>. We help students send luggage, textbooks, backpacks, study furniture, and
                        two-wheelers to all states in India. We supply sturdy cartons and tape directly to your location.
                    </p>
                    <ul class="mt-4 space-y-2 text-xs sm:text-sm text-muted-foreground">
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
                            Cheap book and clothes courier in Jagatpura for college graduates.
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
                ...
                <div>
                    ...
                    <p class="mt-4 text-sm text-muted-foreground leading-relaxed">
                        Send household boxes, gifts, festive sweet parcels, and commercial sample cartons with our <b>bulk
                            packing and parcel delivery in Jaipur Jagatpura</b>. We carry out high-quality bubble wrapping
                        on-site, label every box with a unique tracking code, and provide status updates on WhatsApp.
                    </p>
                    <ul class="mt-4 space-y-2 text-xs sm:text-sm text-muted-foreground">
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
                            Gift and box courier services in Jagatpura for families and merchants.
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
    ...
    <section class="bg-secondary/60 py-16 sm:py-20">
        <div class="mx-auto w-full max-w-7xl px-4 sm:px-6">
            <div class="mx-auto text-center max-w-2xl">
                ...
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                    Same-Day Pickup Across Jagatpura
                </h2>
                <p class="mt-2 text-muted-foreground text-sm">
                    We offer rapid pickup services within 60 minutes in the following localities inside Jagatpura:
                </p>
            </div>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div class="grid gap-12 lg:grid-cols-2 items-center">
            <div>
                <h3 class="text-2xl font-extrabold text-navy sm:text-3xl">Popular Routes from Jagatpura</h3>
                <p class="mt-2 text-muted-foreground text-sm">
                    We connect Jagatpura directly to major economic and educational zones with standard and express
                    options.
                </p>
            ...
            <div class="rounded-3xl bg-brand-gradient p-8 text-white shadow-elevated relative overflow-hidden">
                ...
                <p class="mt-2 text-white/85 text-sm sm:text-base leading-relaxed">
                    Hostelers and PG residents in Jagatpura get exclusive pocket-friendly prices for moving study files,
                    computers, bags, and bicycles. We provide free carton boxes and high-quality bubble wrapping at your location.
                </p>
                <div class="mt-6 flex flex-wrap gap-3">
                    <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20am%20a%20student%20in%20Jagatpura%20Jaipur%20and%20want%20to%20query%20luggage%20rates."
    ...
    <section class="bg-secondary/60">
        <div class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
            <div class="mx-auto text-center max-w-2xl">
                ...
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                    Why Choose JM Courier in Jagatpura
                </h2>
            </div>
            ...
            <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">
                        Book your service before 5:00 PM and we will pick it up the same day from your Jagatpura address.
                    </p>
                </div>
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    <div class="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-accent text-brand">
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 bg-secondary/30 rounded-3xl mb-12">
        <div class="mx-auto text-center max-w-2xl">
            ...
            <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Jagatpura Service FAQs</h2>
        </div>
        ...
        <div class="mx-auto mt-8 max-w-3xl space-y-2 overflow-hidden px-4">
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button
                    ...
                    <span>Do you offer home pickup in Jagatpura, and is it free?</span>
                    <x-icons.plus
                ...
                <div
                    ...
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        Yes! We provide 100% free doorstep collection anywhere in Jagatpura (including Mahal Road, NRI Colony, Ramnagariya, SKIT area, etc.) for all bookings. There are no additional charges for pickup.
                    </p>
                </div>
            </div>
