...
@push('meta')
    <title>Best Courier & Cargo Services in Vaishali Nagar Jaipur | JM Courier</title>
    <meta name="description"
        content="Reliable & fast domestic courier, parcel delivery, luggage transport, and cargo services in Vaishali Nagar, Jaipur. Same-day free doorstep pickup & express shipping to all India.">
    <meta name="keywords"
        content="courier service vaishali nagar jaipur, cargo services vaishali nagar, luggage transport vaishali nagar, parcel delivery vaishali nagar, express delivery jaipur vaishali nagar, vaishali nagar courier collection, document courier vaishali nagar">
    <meta property="og:title" content="Best Courier & Cargo Services in Vaishali Nagar Jaipur | JM Courier">
    <meta property="og:description"
        content="Reliable & fast domestic courier, parcel delivery, luggage transport, and cargo services in Vaishali Nagar, Jaipur. Same-day free doorstep pickup & express shipping to all India.">
    <meta name="twitter:title" content="Best Courier & Cargo Services in Vaishali Nagar Jaipur | JM Courier">
...
@section('content')
    ...
    <section class="relative overflow-hidden bg-hero-gradient text-white">
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
            <div
                ...
                <x-icons.map-pin class="text-gold" /> Serving Vaishali Nagar, Jaipur
            </div>
            <h1 class="mt-4 text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">
                Courier & Cargo Services in <span class="text-gold">Vaishali Nagar, Jaipur</span>
            </h1>
            <p class="mt-4 text-white/85 sm:text-lg max-w-3xl">
                Send documents, parcels, household luggage, or commercial cargo from Vaishali Nagar to any destination across
                India. Enjoy hassle-free door-to-door delivery, free same-day pickup, and tracking at highly competitive rates.
            </p>
            <div class="mt-7 flex flex-wrap gap-3">
                <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20want%20to%20book%20a%20pickup%20from%20Vaishali%20Nagar%20Jaipur."
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div class="space-y-6">
                ...
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                    Reliable Door-to-Door Courier Collection in Vaishali Nagar
                </h2>
                <div class="space-y-4 text-foreground/85 text-sm sm:text-base leading-relaxed">
                    <p>
                        As one of Jaipur's premier residential, commercial, and boutique hubs, Vaishali Nagar demands fast-paced, 
                        high-quality shipping services. Whether you are an upscale showroom or boutique near Amrapali Marg shipping retail collections, 
                        a business office on Gandhi Path sending critical folders, or a resident near Nursery Circle relocating luggage, <b>JM Courier</b> is here to help.
                    </p>
                    <p>
                        We offer a comprehensive suite of logistics services tailored for Vaishali Nagar. Our expert team ensures that your packages are picked up right from your doorstep and dispatched immediately. We handle everything from single urgent document envelopes to massive commercial consignments with equal care and efficiency.
                    </p>
                    <p>
                        With regular routes spanning Queens Road, Gandhi Path, Nursery Circle, Amrapali Marg, Chitrakoot, Hanuman Nagar, and Officer's Campus, our field executives can reach your location within minutes of booking.
                    </p>
                </div>
            ...
            <div class="flex items-center justify-center">
                <img src="{{ asset('images/cities/vaishali-nagar.png') }}" alt="JM Courier Vaishali Nagar" class="rounded-3xl shadow-soft border border-border max-w-full h-auto">
            </div>
        </div>
    </section>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 pb-16 sm:px-6 sm:pb-20">
        <div class="mx-auto text-center max-w-3xl mb-12">
            ...
            <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                Premium Logistics & Shifting Services in Vaishali Nagar
            </h2>
            <p class="mt-3 text-muted-foreground text-sm sm:text-base max-w-2xl mx-auto">
                ...
                for specific home and business shipping requirements in Vaishali Nagar.
            </p>
        </div>
        ...
        <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-2">
            ...
            <div
                ...
                <div>
                    ...
                    <p class="mt-4 text-sm text-muted-foreground leading-relaxed">
                        Are you looking for reliable <b>door-to-door express courier collection in Vaishali Nagar</b>? We
                    ...
                    <ul class="mt-4 space-y-2 text-xs sm:text-sm text-muted-foreground">
                        <li class="flex items-center gap-2">
                            ...
                            Same-day urgent document courier services in Vaishali Nagar Jaipur.
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
                ...
                <div>
                    ...
                    <p class="mt-4 text-sm text-muted-foreground leading-relaxed">
                        Optimize your business distribution with high-quality <b>heavy machinery & retail goods transport in
                            Vaishali Nagar Jaipur</b>. We support manufacturers, local retailers, and wholesalers with
                    ...
                    <ul class="mt-4 space-y-2 text-xs sm:text-sm text-muted-foreground">
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
                            Bulk commercial cargo and boutique parcel booking in Vaishali Nagar.
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
            ...
            <div
                ...
                <div>
                    ...
                    <p class="mt-4 text-sm text-muted-foreground leading-relaxed">
                        Relocating out of a flat or premium PG? Use our dedicated <b>household luggage transport in Vaishali Nagar</b>. 
                    ...
                    <ul class="mt-4 space-y-2 text-xs sm:text-sm text-muted-foreground">
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
                            Household goods courier and bag shifting in Vaishali Nagar.
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
            ...
            <div
                ...
                <div>
                    ...
                    <p class="mt-4 text-sm text-muted-foreground leading-relaxed">
                        Send boutique items, merchandise orders, or family gifts with our <b>bulk packing and parcel delivery in Jaipur Vaishali Nagar</b>. We carry out high-quality bubble wrapping on-site, label every box with a unique tracking code, and provide status updates on WhatsApp.
                    </p>
                    <ul class="mt-4 space-y-2 text-xs sm:text-sm text-muted-foreground">
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
                            Gift and box courier services in Vaishali Nagar for showroom dispatches.
                        </li>
                        <li class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-brand"></span>
    ...
    <section class="bg-secondary/60 py-16 sm:py-20">
        <div class="mx-auto w-full max-w-7xl px-4 sm:px-6">
            <div class="mx-auto text-center max-w-2xl">
                ...
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                    Same-Day Pickup Across Vaishali Nagar
                </h2>
                <p class="mt-2 text-muted-foreground text-sm">
                    We offer rapid pickup services within 60 minutes in the following localities inside Vaishali Nagar:
                </p>
            </div>
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
        <div class="grid gap-12 lg:grid-cols-2 items-center">
            <div>
                <h3 class="text-2xl font-extrabold text-navy sm:text-3xl">Popular Routes from Vaishali Nagar</h3>
                <p class="mt-2 text-muted-foreground text-sm">
                    We connect Vaishali Nagar directly to major economic and educational zones with standard and express
                    options.
                </p>
            ...
            <div class="rounded-3xl bg-brand-gradient p-8 text-white shadow-elevated relative overflow-hidden">
                ...
                <h3 class="mt-4 text-2xl font-extrabold">Premium Shifting & Moving Specials</h3>
                <p class="mt-2 text-white/85 text-sm sm:text-base leading-relaxed">
                    Residents and boutique owners in Vaishali Nagar get premium, pocket-friendly deals for shipping bulk boxes, designer clothes, furniture, and luggage.
                    We provide heavy-duty cardboard boxes and bubble wrapping right at your doorstep.
                </p>
                <div class="mt-6 flex flex-wrap gap-3">
                    <a href="https://wa.me/91{{ config('services.info.phone') }}?text=Hi%20JM%20Courier%2C%20I%20am%20in%20Vaishali%20Nagar%20Jaipur%20and%20want%20to%20query%20shifting%20rates."
    ...
    <section class="bg-secondary/60">
        <div class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20">
            <div class="mx-auto text-center max-w-2xl">
                ...
                <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">
                    Why Choose JM Courier in Vaishali Nagar
                </h2>
            </div>
            ...
            <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">
                        Book your service before 5:00 PM and we will pick it up the same day from your Vaishali Nagar address.
                    </p>
                </div>
                <div class="rounded-2xl border border-border bg-card p-6 transition hover:shadow-soft">
                    <div class="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-accent text-brand">
    ...
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 bg-secondary/30 rounded-3xl mb-12">
        <div class="mx-auto text-center max-w-2xl">
            ...
            <h2 class="text-3xl font-extrabold text-navy sm:text-4xl">Vaishali Nagar Service FAQs</h2>
        </div>
        ...
        <div class="mx-auto mt-8 max-w-3xl space-y-2 overflow-hidden px-4">
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button
                    ...
                    <span>Do you offer home pickup in Vaishali Nagar, and is it free?</span>
                    <x-icons.plus
                ...
                <div
                    ...
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        Yes! We provide 100% free doorstep collection anywhere in Vaishali Nagar (including Amrapali Marg, Gandhi Path, Queens Road, Nursery Circle, etc.) for all bookings. There are no additional charges for pickup.
                    </p>
                </div>
            </div>
            ...
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button
                    class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>Can you pack fragile items, boutique clothing, or high-value showpieces?</span>
                    <x-icons.plus
                        class="h-4 w-4 shrink-0 text-brand transition duration-300 ease-out group-[.is-open]:rotate-45" />
                </button>
                <div
                    class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        Absolutely. We carry high-quality packing supplies like multi-layered bubble wrap, edge guards, stretch film, and heavy-duty cardboard boxes. We pack your delicate showroom items, boutique apparel, or home electronics at your location to ensure maximum safety.
                    </p>
                </div>
            </div>
            ...
            <div class="faq-item rounded-2xl border border-border bg-card group">
                <button
                    class="faq-toggle flex w-full cursor-pointer items-center justify-between gap-4 p-5 font-bold text-navy text-left focus:outline-none">
                    <span>What are your collection timings in Vaishali Nagar?</span>
                    <x-icons.plus
                        class="h-4 w-4 shrink-0 text-brand transition duration-300 ease-out group-[.is-open]:rotate-45" />
                </button>
                <div
                    class="faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0 group-[.is-open]:opacity-100">
                    <p class="px-5 pb-5 text-sm text-muted-foreground">
                        Our physical dispatch and collection teams operate in Vaishali Nagar from 9:00 AM to 8:00 PM daily. However, you can book a request anytime (24/7) via WhatsApp or phone.
                    </p>
                </div>
            </div>
